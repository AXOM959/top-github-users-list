...
The `public contributions` and `private contributions` by users in Palestine on `2023/10/10 12:39 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
