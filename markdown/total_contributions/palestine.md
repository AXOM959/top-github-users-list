...
The `public contributions` and `private contributions` by users in Palestine on `2023/10/21 12:18 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
