...
The `public contributions` and `private contributions` by users in Armenia on `2023/8/9 4:18 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
