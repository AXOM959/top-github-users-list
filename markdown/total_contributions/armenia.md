...
The `public contributions` and `private contributions` by users in Armenia on `2023/10/12 1:47 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
