...
The `public contributions` and `private contributions` by users in Italy on `2023/8/11 10:15 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `981 users`  in Italy. You need at least `60 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>565</td>
		<td>
			<a href="https://github.com/IlonaM8">
				<img src="https://avatars.githubusercontent.com/u/65317944?s=72&u=804765e5c06970a1336df7d1e1726e3b5dc5983c&v=4" width="24" alt="Avatar of IlonaM8"> IlonaM8
			</a><br/>
			Ilona Mereuta
		</td>
		<td>No Company</td>
