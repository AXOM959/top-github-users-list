...
The `public contributions` and `private contributions` by users in Italy on `2023/6/25 1:23 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
