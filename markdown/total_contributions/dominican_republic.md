...
The `public contributions` and `private contributions` by users in Dominican Republic on `2023/8/16 6:15 PM UTC`. This list contains users from `Dominican Republic` and cities `Santo-domingo` `Puerto-plata` `San-pedro-de-macoris` `Santiago-de-los-caballeros` `Higuey`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/BraulioAR">
				<img src="https://avatars.githubusercontent.com/u/49282832?s=72&v=4" width="24" alt="Avatar of BraulioAR"> BraulioAR
			</a><br/>
			Braulio Rosario
		</td>
		<td>No Company</td>
