...
The `public contributions` and `private contributions` by users in Mauritania on `2023/6/14 7:07 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
