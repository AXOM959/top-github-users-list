...
The `public contributions` and `private contributions` by users in Nigeria on `2023/9/22 2:15 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `996 users`  in Nigeria. You need at least `61 followers` to be on this list.
