...
The `public contributions` and `private contributions` by users in Nigeria on `2023/7/20 10:14 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
