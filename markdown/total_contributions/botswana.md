...
The `public contributions` and `private contributions` by users in Botswana on `2023/11/16 3:12 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
