...
The `public contributions` and `private contributions` by users in Botswana on `2023/9/13 7:10 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
