...
The `public contributions` and `private contributions` by users in Afghanistan on `2023/10/29 1:51 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
