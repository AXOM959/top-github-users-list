...
The `public contributions` and `private contributions` by users in Syria on `2023/10/16 8:14 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
