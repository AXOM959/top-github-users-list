...
The `public contributions` and `private contributions` by users in Syria on `2023/10/22 2:11 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
