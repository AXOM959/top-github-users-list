...
The `public contributions` and `private contributions` by users in Latvia on `2023/6/1 8:14 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `964 users`  in Latvia. You need at least `4 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ichmowgli">
				<img src="https://avatars.githubusercontent.com/u/85632615?s=72&u=fa092b23559d55adbe1cf658f0a8d0e022dd94e4&v=4" width="24" alt="Avatar of ichmowgli"> ichmowgli
			</a><br/>
			Mara Kucheieva
		</td>
		<td>Floatwork_ </td>
	...
	<tr>
		...
		<td>Junior Analyst/mulesoft Developer </td>
		<td>No Twitter Username</td>
		<td>Latvia</td>
		<td>36</td>
		<td>36</td>
