...
The `public contributions` and `private contributions` by users in Latvia on `2023/10/3 3:15 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		<td>600</td>
		<td>
			<a href="https://github.com/EtherEssence">
				<img src="https://avatars.githubusercontent.com/u/144780595?s=72&u=4012a91f301dffc279664440e8af8faffd8dd4ec&v=4" width="24" alt="Avatar of EtherEssence"> EtherEssence
			</a><br/>
			Essence
		</td>
		<td>Essencetech </td>
