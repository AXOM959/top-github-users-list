...
The `public contributions` and `private contributions` by users in Latvia on `2023/8/6 12:18 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
