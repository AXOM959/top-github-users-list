...
The `public contributions` and `private contributions` by users in Latvia on `2023/7/13 9:14 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		...
		<td>Hexens </td>
		<td><a href="https://twitter.com/IvanIvanou11971">IvanIvanou11971</a></td>
		<td>Riga, Latvia</td>
		<td>406</td>
		<td>720</td>
	</tr>
