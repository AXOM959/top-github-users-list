...
The `public contributions` and `private contributions` by users in Latvia on `2023/6/7 8:14 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
