...
The `public contributions` and `private contributions` by users in Latvia on `2023/10/31 9:12 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		...
		<td>Rēzekne Academy Of Technologies<br/></td>
		<td>No Twitter Username</td>
		<td>Latvia</td>
		<td>14</td>
		<td>14</td>
