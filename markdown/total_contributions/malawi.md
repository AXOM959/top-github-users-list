...
The `public contributions` and `private contributions` by users in Malawi on `2023/9/4 10:14 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
...
<table>
	...
	<tr>
		<td>319</td>
		<td>
			<a href="https://github.com/MwalaNai">
				<img src="https://avatars.githubusercontent.com/u/131053000?s=72&v=4" width="24" alt="Avatar of MwalaNai"> MwalaNai
			</a><br/>
			Naison Mwala
		</td>
		<td>Crown Harvey International </td>
		<td>No Twitter Username</td>
		<td>Blantyre,Malawi</td>
		<td>10</td>
		<td>10</td>
