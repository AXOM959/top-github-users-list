...
The `public contributions` and `private contributions` by users in Senegal on `2023/10/10 1:17 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
