...
The `public contributions` and `private contributions` by users in Senegal on `2023/9/17 1:12 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
