...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/8/30 4:14 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		<td>500</td>
		<td>
			<a href="https://github.com/projetoBilheteria">
				<img src="https://avatars.githubusercontent.com/u/119008217?s=72&v=4" width="24" alt="Avatar of projetoBilheteria"> projetoBilheteria
			</a><br/>
