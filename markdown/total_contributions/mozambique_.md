...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/7/8 2:13 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/luissitoe">
				<img src="https://avatars.githubusercontent.com/u/70146258?s=72&u=d4b2b101a2eba111262ce622fb07657848c02886&v=4" width="24" alt="Avatar of luissitoe"> luissitoe
			</a><br/>
			Luís Sitoe
		</td>
		<td>No Company</td>
