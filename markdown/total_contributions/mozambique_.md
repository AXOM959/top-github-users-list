...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/11/7 8:16 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/cordeliobarrama">
				<img src="https://avatars.githubusercontent.com/u/150014021?s=72&u=d73a738d840ccb9cd06def0ac1fa85f408114c92&v=4" width="24" alt="Avatar of cordeliobarrama"> cordeliobarrama
			</a><br/>
			Cordelio Barrama
		</td>
		<td>No Company</td>
