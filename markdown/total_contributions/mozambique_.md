...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/9/28 1:47 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
