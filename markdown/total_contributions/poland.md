...
The `public contributions` and `private contributions` by users in Poland on `2023/10/4 11:15 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
