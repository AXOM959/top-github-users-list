...
The `public contributions` and `private contributions` by users in Tanzania on `2023/8/3 12:45 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `949 users`  in Tanzania. You need at least `2 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/JRuggy">
				<img src="https://avatars.githubusercontent.com/u/100377675?s=72&u=97db94c5ceb9e9778d5432f1db9a527622e7d8a2&v=4" width="24" alt="Avatar of JRuggy"> JRuggy
			</a><br/>
