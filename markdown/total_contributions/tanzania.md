...
The `public contributions` and `private contributions` by users in Tanzania on `2023/6/16 6:16 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/crescent-php-pro">
				<img src="https://avatars.githubusercontent.com/u/110913075?s=72&v=4" width="24" alt="Avatar of crescent-php-pro"> crescent-php-pro
			</a><br/>
			Crescent Sambila
		</td>
