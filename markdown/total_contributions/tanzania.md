...
The `public contributions` and `private contributions` by users in Tanzania on `2023/7/22 7:12 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `947 users`  in Tanzania. You need at least `2 followers` to be on this list.
