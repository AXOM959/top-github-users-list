...
The `public contributions` and `private contributions` by users in Tanzania on `2023/6/28 6:18 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
