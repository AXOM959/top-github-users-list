...
The `public contributions` and `private contributions` by users in Sudan on `2023/8/20 2:18 AM UTC`. This list contains users from `Sudan` and cities `Khartoum` `Omdurman`.
