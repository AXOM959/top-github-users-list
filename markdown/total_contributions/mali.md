...
The `public contributions` and `private contributions` by users in Mali on `2023/10/20 4:11 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
