...
The `public contributions` and `private contributions` by users in Mali on `2023/11/18 12:14 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
