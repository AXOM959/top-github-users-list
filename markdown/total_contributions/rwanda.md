...
The `public contributions` and `private contributions` by users in Rwanda on `2023/10/16 4:16 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
