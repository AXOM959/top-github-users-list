...
The `public contributions` and `private contributions` by users in Rwanda on `2023/6/27 12:23 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
