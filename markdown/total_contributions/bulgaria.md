...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/10/18 9:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/desi109">
				<img src="https://avatars.githubusercontent.com/u/40354264?s=72&u=2dfcad65871e32fec1e0e2d68355e365b4a91db9&v=4" width="24" alt="Avatar of desi109"> desi109
			</a><br/>
			Desislava Milusheva
		</td>
		<td>No Company</td>
