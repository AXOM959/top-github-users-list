...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/11/4 4:16 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/linalevcheva">
				<img src="https://avatars.githubusercontent.com/u/120012531?s=72&u=356a636efefb3ae2ee70497454fad96be49dadfa&v=4" width="24" alt="Avatar of linalevcheva"> linalevcheva
			</a><br/>
			Lina
		</td>
		<td>No Company</td>
