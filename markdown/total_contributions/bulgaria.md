...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/7/17 7:14 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/nevenafirkova">
				<img src="https://avatars.githubusercontent.com/u/118193964?s=72&u=63684cd2ec77ff74bde9312aee1c7ecdc74f5e7d&v=4" width="24" alt="Avatar of nevenafirkova"> nevenafirkova
			</a><br/>
			Nevena Firkóva
		</td>
		<td>No Company</td>
