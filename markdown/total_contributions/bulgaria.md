...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/10/6 9:14 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/NikolaRHristov">
				<img src="https://avatars.githubusercontent.com/u/90222871?s=72&u=e34738d728937bcbee1fcee3003653b46ea6b74d&v=4" width="24" alt="Avatar of NikolaRHristov"> NikolaRHristov
			</a><br/>
			Nikola R. Hristov
		</td>
		<td>@playform </td>
