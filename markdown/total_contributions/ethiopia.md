...
The `public contributions` and `private contributions` by users in Ethiopia on `2023/9/26 8:20 AM UTC`. This list contains users from `Ethiopia` and cities `Addis-ababa` `Dire-dawa` `Dire-dawa` `Hawassa` `Dessie`.
