...
The `public contributions` and `private contributions` by users in Georgia on `2023/8/22 8:14 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
