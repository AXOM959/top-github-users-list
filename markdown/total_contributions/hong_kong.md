...
The `public contributions` and `private contributions` by users in Hong Kong on `2023/7/12 5:15 AM UTC`. This list contains users from `Hong Kong` and cities `Hong-kong` `Kowloon`.
