...
The `public contributions` and `private contributions` by users in Norway on `2023/6/14 10:16 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
