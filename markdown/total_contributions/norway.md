...
The `public contributions` and `private contributions` by users in Norway on `2023/6/26 10:20 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
