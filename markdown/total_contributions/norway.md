...
The `public contributions` and `private contributions` by users in Norway on `2023/11/7 4:18 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
