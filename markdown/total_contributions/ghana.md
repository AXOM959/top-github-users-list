...
The `public contributions` and `private contributions` by users in Ghana on `2023/9/15 1:50 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
