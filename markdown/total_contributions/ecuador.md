...
The `public contributions` and `private contributions` by users in Ecuador on `2023/8/22 1:16 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
