...
The `public contributions` and `private contributions` by users in Greece on `2023/7/1 2:38 AM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
