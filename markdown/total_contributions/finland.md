...
The `public contributions` and `private contributions` by users in Finland on `2023/9/9 3:15 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
