...
The `public contributions` and `private contributions` by users in Switzerland on `2023/9/18 1:49 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
...
<table>
	...
	<tr>
		...
		<td>Arteris Ip / Scala<br/>Center<br/></td>
		<td>No Twitter Username</td>
		<td>Lausanne, Switzerland</td>
		<td>401</td>
		<td>711</td>
