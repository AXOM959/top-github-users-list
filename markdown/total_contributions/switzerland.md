...
The `public contributions` and `private contributions` by users in Switzerland on `2023/7/10 4:19 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `916 users`  in Switzerland. You need at least `67 followers` to be on this list.
