...
The `public contributions` and `private contributions` by users in Vietnam on `2023/7/4 6:17 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `965 users`  in Vietnam. You need at least `26 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@agiletechvn @fencilux-ecommerce @kirinrobotics </td>
