...
The `public contributions` and `private contributions` by users in Lithuania on `2023/8/18 1:45 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
