...
The `public contributions` and `private contributions` by users in China on `2023/6/30 4:16 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `971 users`  in China. You need at least `630 followers` to be on this list.
