...
The `public contributions` and `private contributions` by users in Spain on `2023/10/16 3:17 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
