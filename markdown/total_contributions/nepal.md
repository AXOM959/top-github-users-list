...
The `public contributions` and `private contributions` by users in Nepal on `2023/6/2 4:16 PM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dineshlohani">
				<img src="https://avatars.githubusercontent.com/u/51011621?s=72&u=4dd6f5736bdb7f562568461e6327db9517097883&v=4" width="24" alt="Avatar of dineshlohani"> dineshlohani
			</a><br/>
			Dinesh Lohani
		</td>
		<td>Bms </td>
