...
The `public contributions` and `private contributions` by users in Azerbaijan on `2023/10/12 4:16 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
