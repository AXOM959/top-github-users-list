...
The `public contributions` and `private contributions` by users in Oman on `2023/8/1 7:12 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
