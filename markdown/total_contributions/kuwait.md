...
The `public contributions` and `private contributions` by users in Kuwait on `2023/6/1 6:14 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/anasdallah">
				<img src="https://avatars.githubusercontent.com/u/46227234?s=72&v=4" width="24" alt="Avatar of anasdallah"> anasdallah
			</a><br/>
			Anas Al Dallah
		</td>
		<td>Warba Bank </td>
