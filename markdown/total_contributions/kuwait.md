...
The `public contributions` and `private contributions` by users in Kuwait on `2023/10/8 7:10 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
...
<table>
	...
	<tr>
		<td>334</td>
		<td>
			<a href="https://github.com/The-King-2008">
				<img src="https://avatars.githubusercontent.com/u/139647218?s=72&v=4" width="24" alt="Avatar of The-King-2008"> The-King-2008
			</a><br/>
			Abdelrahman Nader Mamdouh
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Kuwait </td>
