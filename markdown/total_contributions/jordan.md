...
The `public contributions` and `private contributions` by users in Jordan on `2023/7/19 5:13 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
