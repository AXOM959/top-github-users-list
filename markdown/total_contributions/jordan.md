...
The `public contributions` and `private contributions` by users in Jordan on `2023/11/6 11:14 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
