...
The `public contributions` and `private contributions` by users in Jordan on `2023/7/31 12:21 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
