...
The `public contributions` and `private contributions` by users in Iraq on `2023/8/6 1:51 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
