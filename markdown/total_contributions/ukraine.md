...
The `public contributions` and `private contributions` by users in Ukraine on `2023/7/22 12:19 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
