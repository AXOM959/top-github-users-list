...
The `public contributions` and `private contributions` by users in Ukraine on `2023/8/8 11:15 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
