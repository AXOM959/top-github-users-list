...
The `public contributions` and `private contributions` by users in Ukraine on `2023/11/14 10:15 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
