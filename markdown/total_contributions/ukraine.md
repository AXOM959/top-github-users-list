...
The `public contributions` and `private contributions` by users in Ukraine on `2023/6/22 11:14 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
