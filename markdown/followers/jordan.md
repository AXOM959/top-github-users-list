...
The `number of followers` of users in Jordan on `2023/9/9 10:12 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
