...
The `number of followers` of users in Jordan on `2023/7/19 5:13 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
