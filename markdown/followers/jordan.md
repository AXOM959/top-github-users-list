...
The `number of followers` of users in Jordan on `2023/8/29 7:14 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
