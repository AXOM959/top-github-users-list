...
The `number of followers` of users in Namibia on `2023/11/1 3:12 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
