...
The `number of followers` of users in Namibia on `2023/11/13 4:14 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
