...
The `number of followers` of users in Namibia on `2023/7/8 4:13 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
