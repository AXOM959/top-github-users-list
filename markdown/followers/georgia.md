...
The `number of followers` of users in Georgia on `2023/10/30 11:14 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
