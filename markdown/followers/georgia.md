...
The `number of followers` of users in Georgia on `2023/10/19 11:14 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
