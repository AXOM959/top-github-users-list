...
The `number of followers` of users in Mozambique  on `2023/7/2 2:12 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
