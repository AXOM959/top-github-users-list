...
The `number of followers` of users in Iran on `2023/6/19 9:15 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
