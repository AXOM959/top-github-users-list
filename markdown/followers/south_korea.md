...
The `number of followers` of users in South Korea on `2023/11/14 9:17 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
