...
The `number of followers` of users in Sri Lanka on `2023/8/8 1:17 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
