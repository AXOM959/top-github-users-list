...
The `number of followers` of users in Cameroon on `2023/10/18 1:18 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
