...
The `number of followers` of users in Cameroon on `2023/9/2 10:13 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
