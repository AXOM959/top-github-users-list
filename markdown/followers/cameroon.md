...
The `number of followers` of users in Cameroon on `2023/8/4 4:15 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
