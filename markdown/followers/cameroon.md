...
The `number of followers` of users in Cameroon on `2023/6/23 11:14 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
