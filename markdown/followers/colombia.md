...
The `number of followers` of users in Colombia on `2023/9/2 5:12 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
