...
The `number of followers` of users in Colombia on `2023/6/30 7:14 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
