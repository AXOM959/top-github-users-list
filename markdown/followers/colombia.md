...
The `number of followers` of users in Colombia on `2023/10/13 2:26 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
