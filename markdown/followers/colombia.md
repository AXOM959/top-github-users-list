...
The `number of followers` of users in Colombia on `2023/5/25 8:20 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
