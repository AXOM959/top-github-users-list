...
The `number of followers` of users in Colombia on `2023/10/24 2:14 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
