...
The `number of followers` of users in Pakistan on `2023/9/16 11:14 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
