...
The `number of followers` of users in Lithuania on `2023/11/18 6:17 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
...
<table>
	...
	<tr>
		...
		<td>@coingate, @rewards-distributed  </td>
		<td>No Twitter Username</td>
		<td>Vilnius, Lithuania</td>
		<td>12</td>
	</tr>
