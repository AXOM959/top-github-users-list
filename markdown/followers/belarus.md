...
The `number of followers` of users in Belarus on `2023/6/29 11:13 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
