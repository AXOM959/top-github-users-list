...
The `number of followers` of users in Benin on `2023/10/18 3:14 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
