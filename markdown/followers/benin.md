...
The `number of followers` of users in Benin on `2023/9/2 12:36 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
