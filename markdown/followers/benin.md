...
The `number of followers` of users in Benin on `2023/8/21 12:18 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
...
<table>
	...
	<tr>
		<td>614</td>
		<td>
			<a href="https://github.com/ellyjoe">
				<img src="https://avatars.githubusercontent.com/u/43567945?s=72&v=4" width="24" alt="Avatar of ellyjoe"> ellyjoe
			</a><br/>
			Eliot
		</td>
		<td>State Ministry Of Health<br/></td>
		<td>No Twitter Username</td>
		<td>Benin City, Nigeria</td>
		<td>1</td>
	</tr>
