...
The `number of followers` of users in Benin on `2023/11/10 4:15 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
