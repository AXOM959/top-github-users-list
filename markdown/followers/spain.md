...
The `number of followers` of users in Spain on `2023/9/23 3:14 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
