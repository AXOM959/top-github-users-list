...
The `number of followers` of users in Bulgaria on `2023/8/21 6:15 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
