...
The `number of followers` of users in Bulgaria on `2023/8/27 12:18 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
