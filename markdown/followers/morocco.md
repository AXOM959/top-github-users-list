...
The `number of followers` of users in Morocco on `2023/10/3 6:17 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
