...
The `number of followers` of users in Peru on `2023/11/19 11:12 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
