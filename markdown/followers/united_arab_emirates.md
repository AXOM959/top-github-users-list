...
The `number of followers` of users in United Arab Emirates on `2023/6/28 12:15 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
