...
The `number of followers` of users in United Arab Emirates on `2023/7/28 11:05 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
