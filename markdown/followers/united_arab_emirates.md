...
The `number of followers` of users in United Arab Emirates on `2023/10/17 3:08 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
