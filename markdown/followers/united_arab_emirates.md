...
The `number of followers` of users in United Arab Emirates on `2023/6/10 11:04 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
