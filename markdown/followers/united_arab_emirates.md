...
The `number of followers` of users in United Arab Emirates on `2023/9/24 3:07 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
