...
The `number of followers` of users in Philippines on `2023/7/27 6:17 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
