...
The `number of followers` of users in Cyprus on `2023/9/8 6:16 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
