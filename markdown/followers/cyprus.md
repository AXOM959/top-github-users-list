...
The `number of followers` of users in Cyprus on `2023/6/24 11:13 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
