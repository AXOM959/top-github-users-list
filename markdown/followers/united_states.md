...
The `number of followers` of users in United States on `2023/10/11 11:16 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
