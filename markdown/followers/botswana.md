...
The `number of followers` of users in Botswana on `2023/9/19 1:15 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
