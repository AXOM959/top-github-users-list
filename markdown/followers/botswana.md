...
The `number of followers` of users in Botswana on `2023/10/29 7:09 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
