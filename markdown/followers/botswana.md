...
The `number of followers` of users in Botswana on `2023/10/1 1:57 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
