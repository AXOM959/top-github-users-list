...
The `number of followers` of users in Nicaragua on `2023/6/2 7:11 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
