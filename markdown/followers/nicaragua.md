...
The `number of followers` of users in Nicaragua on `2023/11/13 8:17 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
