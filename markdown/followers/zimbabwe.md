...
The `number of followers` of users in Zimbabwe on `2023/8/26 3:12 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
...
<table>
	...
	<tr>
		<td>793</td>
		<td>
			<a href="https://github.com/simbapows">
				<img src="https://avatars.githubusercontent.com/u/142400548?s=72&v=4" width="24" alt="Avatar of simbapows"> simbapows
			</a><br/>
			Simbarashe Chipiso
		</td>
