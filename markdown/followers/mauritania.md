...
The `number of followers` of users in Mauritania on `2023/9/16 6:09 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
