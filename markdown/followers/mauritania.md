...
The `number of followers` of users in Mauritania on `2023/7/14 7:08 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
