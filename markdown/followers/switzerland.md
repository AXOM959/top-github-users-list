...
The `number of followers` of users in Switzerland on `2023/10/22 1:15 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
