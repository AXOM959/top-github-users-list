...
The `number of followers` of users in Switzerland on `2023/5/29 3:15 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
