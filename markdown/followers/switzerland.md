...
The `number of followers` of users in Switzerland on `2023/6/28 4:17 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
