...
The `number of followers` of users in Switzerland on `2023/7/10 4:19 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
