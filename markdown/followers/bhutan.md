...
The `number of followers` of users in Bhutan on `2023/8/21 1:12 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
