...
The `number of followers` of users in Bhutan on `2023/10/6 4:12 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
