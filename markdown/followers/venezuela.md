...
The `number of followers` of users in Venezuela on `2023/11/3 2:14 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
