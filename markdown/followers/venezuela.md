...
The `number of followers` of users in Venezuela on `2023/7/4 5:14 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
