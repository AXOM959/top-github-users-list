...
The `number of followers` of users in Saudi Arabia on `2023/8/25 9:13 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
