...
The `number of followers` of users in Saudi Arabia on `2023/11/2 12:20 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
