...
The `number of followers` of users in Saudi Arabia on `2023/9/11 6:16 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
