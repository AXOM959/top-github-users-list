...
The `number of followers` of users in Turkey on `2023/10/28 12:19 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `985 users`  in Turkey. You need at least `115 followers` to be on this list.
