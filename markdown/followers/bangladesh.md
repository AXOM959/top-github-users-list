...
The `number of followers` of users in Bangladesh on `2023/7/23 11:12 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
