...
The `number of followers` of users in Bangladesh on `2023/8/4 3:14 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
