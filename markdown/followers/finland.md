...
The `number of followers` of users in Finland on `2023/8/11 6:17 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
