...
The `number of followers` of users in Finland on `2023/10/7 9:13 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
