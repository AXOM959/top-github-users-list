...
The `number of followers` of users in Poland on `2023/9/22 11:16 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
