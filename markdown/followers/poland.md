...
The `number of followers` of users in Poland on `2023/10/21 5:14 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
