...
The `number of followers` of users in Azerbaijan on `2023/11/4 5:14 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
