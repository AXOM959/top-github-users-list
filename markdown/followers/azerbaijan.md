...
The `number of followers` of users in Azerbaijan on `2023/11/15 6:17 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
