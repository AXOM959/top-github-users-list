...
The `number of followers` of users in Kuwait on `2023/9/21 1:17 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
