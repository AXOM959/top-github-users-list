...
The `public contributions` by users in Botswana on `2023/10/12 1:15 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
