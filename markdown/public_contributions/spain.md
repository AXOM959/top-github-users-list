...
The `public contributions` by users in Spain on `2023/11/8 4:18 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
