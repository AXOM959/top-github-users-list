...
The `public contributions` by users in Spain on `2023/10/22 9:15 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
