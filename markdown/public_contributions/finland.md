...
The `public contributions` by users in Finland on `2023/5/25 9:14 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
