...
The `public contributions` by users in Finland on `2023/10/19 9:17 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
...
<table>
	...
	<tr>
		...
		<td>@wikimedia Cloud Services </td>
		<td>No Twitter Username</td>
		<td>Helsinki, Finland</td>
		<td>1710</td>
	</tr>
