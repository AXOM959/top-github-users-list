...
The `public contributions` by users in Jordan on `2023/5/26 4:15 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
