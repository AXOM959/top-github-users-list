...
The `public contributions` by users in Jordan on `2023/9/4 1:48 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
