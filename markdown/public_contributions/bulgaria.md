...
The `public contributions` by users in Bulgaria on `2023/10/29 9:13 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
