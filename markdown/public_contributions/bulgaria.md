...
The `public contributions` by users in Bulgaria on `2023/9/2 6:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
