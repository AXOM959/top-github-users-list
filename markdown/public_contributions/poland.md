...
The `public contributions` by users in Poland on `2023/11/13 6:18 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
