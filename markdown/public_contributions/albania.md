...
The `public contributions` by users in Albania on `2023/7/28 10:12 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
...
<table>
	...
	<tr>
		<td>532</td>
		<td>
			<a href="https://github.com/sejdaMecaj">
				<img src="https://avatars.githubusercontent.com/u/118691320?s=72&v=4" width="24" alt="Avatar of sejdaMecaj"> sejdaMecaj
			</a><br/>
			Sejda Mecaj
		</td>
		<td>No Company</td>
