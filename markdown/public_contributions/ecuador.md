...
The `public contributions` by users in Ecuador on `2023/7/30 12:19 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
