...
The `public contributions` by users in Ecuador on `2023/9/20 10:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
