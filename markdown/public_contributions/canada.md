...
The `public contributions` by users in Canada on `2023/10/24 8:20 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `964 users`  in Canada. You need at least `176 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Mcmaster University </td>
		<td><a href="https://twitter.com/jjcarett2">jjcarett2</a></td>
	...
	<tr>
		...
		<td>Technology Firm That Tackles<br/>Enterprise<br/>Supply<br/>Chain<br/>Management<br/>And<br/>Logistics<br/></td>
		<td>No Twitter Username</td>
		<td>Canada</td>
		<td>25</td>
	</tr>
