...
The `public contributions` by users in Canada on `2023/10/1 8:18 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		<td>611</td>
		<td>
			<a href="https://github.com/HuguesTHOMAS">
				<img src="https://avatars.githubusercontent.com/u/16581582?s=72&u=315c1b4921f722e2e3c813217cd43bc8fb7c6fd4&v=4" width="24" alt="Avatar of HuguesTHOMAS"> HuguesTHOMAS
			</a><br/>
			Hugues THOMAS
		</td>
		<td>University Of Toronto </td>
