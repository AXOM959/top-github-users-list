...
The `public contributions` by users in Canada on `2023/6/11 11:15 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/brunokirby-dev">
				<img src="https://avatars.githubusercontent.com/u/135716537?s=72&u=c3c02af1a59d84cc418da3a2e301ecfd1e892edf&v=4" width="24" alt="Avatar of brunokirby-dev"> brunokirby-dev
			</a><br/>
			Bruno Kirby
		</td>
		<td>No Company</td>
