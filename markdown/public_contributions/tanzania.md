...
The `public contributions` by users in Tanzania on `2023/10/5 9:15 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
