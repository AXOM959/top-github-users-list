...
The `public contributions` by users in Tanzania on `2023/8/3 12:45 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
