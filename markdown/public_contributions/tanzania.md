...
The `public contributions` by users in Tanzania on `2023/9/12 9:14 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
