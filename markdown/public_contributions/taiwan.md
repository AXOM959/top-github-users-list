...
The `public contributions` by users in Taiwan on `2023/10/24 1:18 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
