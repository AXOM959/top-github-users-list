...
The `public contributions` by users in Taiwan on `2023/10/1 1:15 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `978 users`  in Taiwan. You need at least `50 followers` to be on this list.
