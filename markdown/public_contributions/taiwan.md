...
The `public contributions` by users in Taiwan on `2023/10/13 1:53 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
...
<table>
	...
	<tr>
		...
		<td>Boston, MA, USA / Taipei, Taiwan</td>
		<td>1585</td>
	</tr>
	<tr>
		<td>36</td>
