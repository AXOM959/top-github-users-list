...
The `public contributions` by users in Palestine on `2023/11/2 12:39 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
