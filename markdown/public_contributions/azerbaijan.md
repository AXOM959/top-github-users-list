...
The `public contributions` by users in Azerbaijan on `2023/9/30 4:14 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
