...
The `public contributions` by users in Azerbaijan on `2023/7/11 8:18 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
